...
const COLOR_PRIMITIVES = {
  ...BOLT_BASE_COLORS,
  alpha: {
    white: generateAlphaPalette(BOLT_BASE_COLORS.white),
    gray: generateAlphaPalette(BOLT_BASE_COLORS.gray[900]),
    red: generateAlphaPalette(BOLT_BASE_COLORS.red[500]),
    accent: generateAlphaPalette(BOLT_BASE_COLORS.accent[500]),
  },
};

export const boltColors = {
  accent: COLOR_PRIMITIVES.accent,
  alpha: COLOR_PRIMITIVES.alpha,
  elements: {
